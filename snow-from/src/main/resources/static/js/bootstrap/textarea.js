    ...
    let TextareaDom = function(parentDom,moreProps=null){
        ...
        switch (ortum_component_properties.data.authority) {
            ...
            case "edit":
                ...
                $(outerDom).find("textarea").removeAttr("readonly");
                $(outerDom).find("textarea").removeAttr("disabled");
                // $("*[ortum_bindcomponentname="+ ortum_component_properties.data.name +"]").parents(".ortum_item").eq(0).removeClass("ortum_display_NONE");
                break;
            case "readonly":
                $(outerDom).removeClass("ortum_display_NONE");
                $(outerDom).find("textarea").attr("readonly","readonly");
                $(outerDom).find("textarea").removeAttr("disabled");
                // $("*[ortum_bindcomponentname="+ ortum_component_properties.data.name +"]").parents(".ortum_item").eq(0).removeClass("ortum_display_NONE");
                break;
            case "disabled":
                $(outerDom).removeClass("ortum_display_NONE");
                $(outerDom).find("textarea").attr("readonly","readonly");
                $(outerDom).find("textarea").attr("disabled","disabled");
                // $("*[ortum_bindcomponentname="+ ortum_component_properties.data.name +"]").parents(".ortum_item").eq(0).removeClass("ortum_display_NONE");
                break;
            default:
                break;
        ...
        switch(property){
            case "authority":
                ...
                if(val=="edit"){//可编辑
                    ...
                    $(globalComponent).find("textarea").removeAttr("readonly");
                    $(globalComponent).find("textarea").removeAttr("disabled");
                ...
                if(val=="readonly"){//只读可点击
                    $(globalComponent).removeClass("ortum_display_NONE");
                    $(globalComponent).find("textarea").attr("readonly","readonly");
                    $(globalComponent).find("textarea").removeAttr("disabled");
                    // $("*[ortum_bindcomponentname="+ evenProperties.data.name +"]").parents(".ortum_item").eq(0).removeClass("ortum_display_NONE");
                }
                if(val=="disabled"){//只读且无法点击
                    $(globalComponent).removeClass("ortum_display_NONE");
                    $(globalComponent).find("textarea").attr("readonly","readonly");
                    $(globalComponent).find("textarea").attr("disabled","disabled");
                    // $("*[ortum_bindcomponentname="+ evenProperties.data.name +"]").parents(".ortum_item").eq(0).removeClass("ortum_display_NONE");
                }
                break;
            case "hideLabel":
