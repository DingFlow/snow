...
@Service
@Slf4j
public class PurchaseOrderCancelEndListener extends AbstractExecutionListener<PurchaseOrderForm> {
    ...
    protected void process() {
        ...
        purchaseOrderMain.setProcessStatus((long)ProcessStatus.CANCEL.ordinal());
