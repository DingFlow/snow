...
@Service
@Slf4j
public class PurchaseOrderEndListener extends AbstractExecutionListener<PurchaseOrderForm> {
    ...
    protected void process() {
        ...
        purchaseOrderMain.setProcessStatus((long)ProcessStatus.PASS.ordinal());
